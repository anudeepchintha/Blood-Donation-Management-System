...
<%@ page import="java.io.*" %>
		...
		String blood_group=request.getParameter("type");
		...
		st.executeUpdate("insert into blooddonors_details values('"+donor_id+"','"+first_name+"','"+last_name+"','"+age+"','"+mobile+"','"+city_name+"','"+email+"','"+blood_group+"')");
		...
		%><center>
		<pre>Thank you! for donating blood</pre></center>
